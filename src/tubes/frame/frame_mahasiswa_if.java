    ...
    private void initComponents() {
        ...
        txt_cari_nim_if.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_cari_nim_ifKeyReleased(evt);
            }
        });
...
//setText(tableModel.getValueAt(row, 3).toString());
    ...
    private void txt_cari_nim_ifKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cari_nim_ifKeyReleased
        // TODO add your handling code here:
        tableModel.setRowCount(0);
        String cari;
        cari = txt_cari_nim_if.getText();
        String SQL = null;
        try {
            Class.forName(driver);
            Connection kon = DriverManager.getConnection(
            ...
            SQL = "SELECT * FROM t_mahasiswa WHERE nim LIKE "
                    + "'%" + cari + "%' OR nama LIKE "
                    + "'%" + cari + "%' OR ttl LIKE '%" + cari + "%'";

            ResultSet res = stt.executeQuery(SQL);
            while (res.next()) {
                data[0] = res.getString("nim");
                data[1] = res.getString("nama");
                data[2] = res.getString("ttl");
